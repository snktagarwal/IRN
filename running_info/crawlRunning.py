...
if __name__=='__main__':
	...
	if sys.argv[1] == 'DEBUG':
		parseRunningInfoOutput('RunningInfo.out')
	else:
		# Always backup before doing any changes. Backup
		# to the current time
		backupRunningInfo('RunningInfo.out')
		#crawled = parseRunningInfoOutput('RunningInfo.out')
		...
		crawlDataWithDate(trainDetails,  datetime.date(2011,8,22), './crawl/')
